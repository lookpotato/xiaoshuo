...
4. 若没有待上传章节，则规划并生成 `next_chapter_number`，进行连续性、章节结构、文风、
   ...
   正文每两章至少一次、每章最多两次由旁白或陈序直接称呼读者老爷、预判吐槽或邀请站队；每次只用
   一句或短段，不解释关键因果、不剧透、不索要点赞打赏。允许出现“读者”，但仍禁止暴露AI与生产流程。
   ...
   必须用 Codex imagegen 配图并回看六项核验，同名实体沿用旧图，每章最多 1 张；图片不正确、
...
9. 每次运行只在本书日志记录 `meme_scan`、“最强场景、最弱场景、连续性风险、
   观察证据、下一次实验”和次元壁互动位置。创作经验不得写入共享手册；只有本书的明确读者反馈
